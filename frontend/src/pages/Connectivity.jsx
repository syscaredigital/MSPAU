            ...
            >
              ...
              >
                <div className="flex items-start mb-6">
                  <div className="w-14 h-12 rounded-xl bg-[#f0f6ff] flex items-center justify-center mr-8 border border-[#103d5d]">
                ...
                <p className="text-[#103d5d] text-md mb-8 leading-relaxed ">{services[activeTab].content}</p>
              </div>
            </div>
          )}
        </div>
