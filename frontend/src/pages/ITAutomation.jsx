...
import SysCarePrivateCloud from '../assets/website-images/Office-IT-Automation.png';
...
const FAQS = [
  {
    question: "1. What is Office IT Automation and why is it important for my business?",
    answer: (
      <>
         Office IT Automation involves using technology to streamline repetitive tasks, optimize workflows, and enhance collaboration. It improves productivity, reduces errors, and allows employees to focus on higher-value initiatives, saving time and costs.</>
    ),
  },
  {
    question: "2. How can SharePoint Workflows improve business processes?",
    answer: (
      <>
         SysCare’s SharePoint Workflows automate approvals, document management, and task tracking. This ensures processes run smoothly, reduces manual errors, and enhances collaboration across teams. Workflows can be customized to match your business operations.</>
    ),
  },
  {
    question: "3. What are PowerApps and how can they benefit my company?",
    answer: (
      <>
        PowerApps allows businesses to create custom apps without extensive coding. SysCare builds tailored PowerApps to automate processes, streamline data entry, and enable employees to work more efficiently across departments.</>
    ),
  },
  {
    question: "4. How does Power BI help with decision-making?",
    answer: (
      <>
        Power BI transforms raw data into interactive dashboards and visual reports. SysCare’s Power BI services provide actionable insights, enabling managers to make data-driven decisions quickly and accurately.</>
    ),
  },
  {
    question: "5. What is Power Automation, and what tasks can it automate?",
    answer: (
      <>
         Power Automate automates repetitive processes such as email notifications, approvals, data synchronization, and reporting. With SysCare’s Power Automation services, businesses can save time, reduce manual errors, and ensure critical workflows run consistently.</>
    ),
  },
  {
    question: "6. How does AI Transformation enhance Office IT Automation?",
    answer: (
      <>
         SysCare integrates AI to analyze data, predict trends, and automate tasks like customer responses or reporting. AI Transformation improves efficiency, helps in strategic decision-making, and reduces workload for employees. </>
    ),
  },
];
